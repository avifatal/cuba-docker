package com.company.deploytest;
...
public class DeploytestTestContainer extends TestContainer {

    public DeploytestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/deploytest/app.properties",
    ...
    public static class Common extends DeploytestTestContainer {

        public static final DeploytestTestContainer.Common INSTANCE = new DeploytestTestContainer.Common();
